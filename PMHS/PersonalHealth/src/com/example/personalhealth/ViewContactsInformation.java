...
import com.example.personalhealth.contactsDB.Row;

public class ViewContactsInformation extends ActionBarActivity {
...
*/	
	...
	//Set all of the user information in the textviews
		public void get_textviews_for_user_information()
		{
			...
			setContentView(R.layout.fragment_contacts_page);
