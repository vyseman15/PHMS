...
public class contactsDB{
	...
	class Row extends Object {
        public int Contacts_Key,phoneNumber;
        public String firstName, lastName, email, address, city, state, zipcode, Username, Date;
    }
    ...
    private static final String DATABASE_CREATE =
        "CREATE TABLE IF NOT EXISTS USERHEALTHDATA(Contacts_Key INTEGER PRIMARY KEY AUTOINCREMENT, "
        	+ "Username TEXT, "
            + "Date TEXT, "
            + "firstName TEXT, "
            + "lastName TEXT, "
    ...
    private static final String DATABASE_TABLE = "CONTACTINFODATA";
