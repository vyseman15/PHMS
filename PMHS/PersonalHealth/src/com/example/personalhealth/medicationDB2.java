...
public class medicationDB2 {
    ...
    private static final String DATABASE_CREATE =
            "CREATE TABLE IF NOT EXISTS USERDATA_Medication(Place INTEGER PRIMARY KEY AUTOINCREMENT, "
            		+ "Username TEXT, "
                    + "PillName TEXT, "
                    + "OTCName TEXT, "
                    + "TOD TEXT, "
    ...
    private static final String DATABASE_NAME = "USERDB_Medication2";

    private static final String DATABASE_TABLE = "USERDATA_Medication";

    private SQLiteDatabase db;

    public medicationDB2(Context ctx) {
    ...
    public int checkExists(int place) {
    	int exists=0;
    ...
    public void updateRow(int Place, int NewPlace, String Username, String PillName, String OTCName,
            String TOD, String TPD, String Dose, String Special_Instructions, String Known_Conflicts) 
    {
        ContentValues userValues = new ContentValues();
        userValues.put("Place",NewPlace);
        userValues.put("Username", Username);
        userValues.put("PillName", PillName);
        userValues.put("OTCName", OTCName);
        userValues.put("TOD", TOD);
    ...
    {
    	int lastPlace=0;
    	Cursor c=db.rawQuery("SELECT Place FROM USERDATA_Medication ORDER BY Place DESC LIMIT 1", null);
    	if ((c != null) && (c.moveToFirst())) 
    	{
